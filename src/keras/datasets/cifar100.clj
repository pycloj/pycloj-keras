...
(defn get-file 
  ...
  [ & {:keys [fname origin untar md5_hash file_hash cache_subdir hash_algorithm extract archive_format cache_dir]
   ...
   (py/call-attr-kw cifar100 "get_file" [] {:fname fname :origin origin :untar untar :md5_hash md5_hash :file_hash file_hash :cache_subdir cache_subdir :hash_algorithm hash_algorithm :extract extract :archive_format archive_format :cache_dir cache_dir }))
...
(defn load-batch 
  ...
  [ & {:keys [fpath label_key]
   ...
   (py/call-attr-kw cifar100 "load_batch" [] {:fpath fpath :label_key label_key }))
