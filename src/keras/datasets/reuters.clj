...
(defn get-file 
  ...
  [ & {:keys [fname origin untar md5_hash file_hash cache_subdir hash_algorithm extract archive_format cache_dir]
   ...
   (py/call-attr-kw reuters "get_file" [] {:fname fname :origin origin :untar untar :md5_hash md5_hash :file_hash file_hash :cache_subdir cache_subdir :hash_algorithm hash_algorithm :extract extract :archive_format archive_format :cache_dir cache_dir }))
...
(defn get-word-index 
  "Retrieves the dictionary mapping words to word indices.
    ...
    "
  [ & {:keys [path]
       :or {path "reuters_word_index.json"}} ]
...
(defn load-data 
  ...
  [ & {:keys [path num_words skip_top maxlen test_split seed start_char oov_char index_from]
       :or {path "reuters.npz" skip_top 0 test_split 0.2 seed 113 start_char 1 oov_char 2 index_from 3}} ]
