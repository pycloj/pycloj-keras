(ns keras.layers.ConvLSTM2DCell
...
(defn ConvLSTM2DCell 
  ...
  [ & {:keys [filters kernel_size strides padding data_format dilation_rate activation recurrent_activation use_bias kernel_initializer recurrent_initializer bias_initializer unit_forget_bias kernel_regularizer recurrent_regularizer bias_regularizer kernel_constraint recurrent_constraint bias_constraint dropout recurrent_dropout]
   ...
   (py/call-attr-kw layers "ConvLSTM2DCell" [] {:filters filters :kernel_size kernel_size :strides strides :padding padding :data_format data_format :dilation_rate dilation_rate :activation activation :recurrent_activation recurrent_activation :use_bias use_bias :kernel_initializer kernel_initializer :recurrent_initializer recurrent_initializer :bias_initializer bias_initializer :unit_forget_bias unit_forget_bias :kernel_regularizer kernel_regularizer :recurrent_regularizer recurrent_regularizer :bias_regularizer bias_regularizer :kernel_constraint kernel_constraint :recurrent_constraint recurrent_constraint :bias_constraint bias_constraint :dropout dropout :recurrent_dropout recurrent_dropout }))
...
(defn call 
  ...
  [self  & {:keys [inputs states training]} ]
    (py/call-attr-kw layers "call" [self] {:inputs inputs :states states :training training }))
...
(defn input-conv 
  ...
  [self & {:keys [x w b padding]
                       :or {padding "valid"}} ]
    (py/call-attr-kw layers "input_conv" [] {:x x :w w :b b :padding padding }))
...
(defn recurrent-conv 
  ""
  [self  & {:keys [x w]} ]
    (py/call-attr-kw layers "recurrent_conv" [self] {:x x :w w }))
