...
(defn RNN 
  ...
  [ & {:keys [cell return_sequences return_state go_backwards stateful unroll]
   ...
   (py/call-attr-kw layers "RNN" [] {:cell cell :return_sequences return_sequences :return_state return_state :go_backwards go_backwards :stateful stateful :unroll unroll }))
