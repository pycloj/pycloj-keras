...
(defn ConvLSTM2DCell 
  ...
  [filters kernel_size & {:keys [strides padding data_format dilation_rate activation recurrent_activation use_bias kernel_initializer recurrent_initializer bias_initializer unit_forget_bias kernel_regularizer recurrent_regularizer bias_regularizer kernel_constraint recurrent_constraint bias_constraint dropout recurrent_dropout]
    ...
    (py/call-attr-kw convolutional-recurrent "ConvLSTM2DCell" [filters kernel_size] {:strides strides :padding padding :data_format data_format :dilation_rate dilation_rate :activation activation :recurrent_activation recurrent_activation :use_bias use_bias :kernel_initializer kernel_initializer :recurrent_initializer recurrent_initializer :bias_initializer bias_initializer :unit_forget_bias unit_forget_bias :kernel_regularizer kernel_regularizer :recurrent_regularizer recurrent_regularizer :bias_regularizer bias_regularizer :kernel_constraint kernel_constraint :recurrent_constraint recurrent_constraint :bias_constraint bias_constraint :dropout dropout :recurrent_dropout recurrent_dropout }))
(defn add-loss 
...
(defn call 
  ""
  [self inputs states  & {:keys [training]} ]
    (py/call-attr-kw self "call" [inputs states] {:training training }))
(defn compute-mask 
...
(defn input-conv 
  ""
  [self x w & {:keys [b padding]
                       :or {padding "valid"}} ]
    (py/call-attr-kw self "input_conv" [x w] {:b b :padding padding }))
...
(defn recurrent-conv 
  ""
  [ self x w ]
  (py/call-attr self "recurrent_conv"  self x w ))
