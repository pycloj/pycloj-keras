(ns keras.layers.convolutional-recurrent.ConvLSTM2DCell
  ...
  "Cell class for the ConvLSTM2D layer.
    ...
    # Arguments
        ...
        recurrent_dropout: Float between 0 and 1.
            ...
            the linear transformation of the recurrent state.
    "
  [ & {:keys [filters kernel_size strides padding data_format dilation_rate activation recurrent_activation use_bias kernel_initializer recurrent_initializer bias_initializer unit_forget_bias kernel_regularizer recurrent_regularizer bias_regularizer kernel_constraint recurrent_constraint bias_constraint dropout recurrent_dropout]
       :or {strides (1, 1) padding "valid" dilation_rate (1, 1) activation "tanh" recurrent_activation "hard_sigmoid" use_bias true kernel_initializer "glorot_uniform" recurrent_initializer "orthogonal" bias_initializer "zeros" unit_forget_bias true dropout 0.0 recurrent_dropout 0.0}} ]
  
   (py/call-attr-kw convolutional-recurrent "ConvLSTM2DCell" [] {:filters filters :kernel_size kernel_size :strides strides :padding padding :data_format data_format :dilation_rate dilation_rate :activation activation :recurrent_activation recurrent_activation :use_bias use_bias :kernel_initializer kernel_initializer :recurrent_initializer recurrent_initializer :bias_initializer bias_initializer :unit_forget_bias unit_forget_bias :kernel_regularizer kernel_regularizer :recurrent_regularizer recurrent_regularizer :bias_regularizer bias_regularizer :kernel_constraint kernel_constraint :recurrent_constraint recurrent_constraint :bias_constraint bias_constraint :dropout dropout :recurrent_dropout recurrent_dropout }))
...
(defn call 
  ""
  [self  & {:keys [inputs states training]} ]
    (py/call-attr-kw convolutional-recurrent "call" [self] {:inputs inputs :states states :training training }))
...
(defn input-conv 
  ""
  [self & {:keys [x w b padding]
                       :or {padding "valid"}} ]
    (py/call-attr-kw convolutional-recurrent "input_conv" [] {:x x :w w :b b :padding padding }))
...
(defn recurrent-conv 
  ""
  [self  & {:keys [x w]} ]
    (py/call-attr-kw convolutional-recurrent "recurrent_conv" [self] {:x x :w w }))
