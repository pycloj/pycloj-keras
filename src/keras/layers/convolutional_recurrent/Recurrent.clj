(ns keras.layers.convolutional-recurrent.Recurrent
...
(defn Recurrent 
  ...
  [ & {:keys [return_sequences return_state go_backwards stateful unroll implementation]
   ...
   (py/call-attr-kw convolutional-recurrent "Recurrent" [] {:return_sequences return_sequences :return_state return_state :go_backwards go_backwards :stateful stateful :unroll unroll :implementation implementation }))
