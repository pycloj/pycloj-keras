(ns keras.layers.convolutional-recurrent.Layer
...
(defn Layer 
  "Abstract base layer class.
    ...
    "
  [  ]
  (py/call-attr convolutional-recurrent "Layer"   ))
...
(defn call 
  "This is where the layer's logic lives.
        ...
        "
  [self  & {:keys [inputs]} ]
    (py/call-attr-kw convolutional-recurrent "call" [self] {:inputs inputs }))
