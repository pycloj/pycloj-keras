(ns keras.layers.pooling.AveragePooling2D
...
(defn AveragePooling2D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw pooling "AveragePooling2D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
(defn add-loss 
