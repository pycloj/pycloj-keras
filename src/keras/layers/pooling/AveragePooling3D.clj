(ns keras.layers.pooling.AveragePooling3D
...
(defn AveragePooling3D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw pooling "AveragePooling3D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
