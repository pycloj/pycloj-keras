(ns keras.layers.pooling.AveragePooling1D
...
(defn AveragePooling1D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw pooling "AveragePooling1D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
