...
(defn InputLayer 
  ...
  [ & {:keys [input_shape batch_size batch_input_shape dtype input_tensor sparse name]
   ...
   (py/call-attr-kw layers "InputLayer" [] {:input_shape input_shape :batch_size batch_size :batch_input_shape batch_input_shape :dtype dtype :input_tensor input_tensor :sparse sparse :name name }))
(defn add-loss 
