  ...
  "Long Short-Term Memory layer - Hochreiter 1997.
    ...
    # References
        ...
        - [A Theoretically Grounded Application of Dropout in
           Recurrent Neural Networks](https://arxiv.org/abs/1512.05287)
    "
  [ & {:keys [units activation recurrent_activation use_bias kernel_initializer recurrent_initializer bias_initializer unit_forget_bias kernel_regularizer recurrent_regularizer bias_regularizer activity_regularizer kernel_constraint recurrent_constraint bias_constraint dropout recurrent_dropout implementation return_sequences return_state go_backwards stateful unroll]
       :or {activation "tanh" recurrent_activation "hard_sigmoid" use_bias true kernel_initializer "glorot_uniform" recurrent_initializer "orthogonal" bias_initializer "zeros" unit_forget_bias true dropout 0.0 recurrent_dropout 0.0 implementation 1 return_sequences false return_state false go_backwards false stateful false unroll false}} ]
  
   (py/call-attr-kw layers "LSTM" [] {:units units :activation activation :recurrent_activation recurrent_activation :use_bias use_bias :kernel_initializer kernel_initializer :recurrent_initializer recurrent_initializer :bias_initializer bias_initializer :unit_forget_bias unit_forget_bias :kernel_regularizer kernel_regularizer :recurrent_regularizer recurrent_regularizer :bias_regularizer bias_regularizer :activity_regularizer activity_regularizer :kernel_constraint kernel_constraint :recurrent_constraint recurrent_constraint :bias_constraint bias_constraint :dropout dropout :recurrent_dropout recurrent_dropout :implementation implementation :return_sequences return_sequences :return_state return_state :go_backwards go_backwards :stateful stateful :unroll unroll }))
