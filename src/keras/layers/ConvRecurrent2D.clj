(ns keras.layers.ConvRecurrent2D
...
(defn ConvRecurrent2D 
  ...
  [filters kernel_size & {:keys [strides padding data_format dilation_rate return_sequences go_backwards stateful]
    ...
    (py/call-attr-kw layers "ConvRecurrent2D" [filters kernel_size] {:strides strides :padding padding :data_format data_format :dilation_rate dilation_rate :return_sequences return_sequences :go_backwards go_backwards :stateful stateful }))
(defn add-loss 
