...
(defn implementation 
  ""
  [ self ]
    (py/call-attr recurrent "implementation"  self))
...
(defn recurrent-activation 
  ""
  [ self ]
    (py/call-attr recurrent "recurrent_activation"  self))
...
(defn reset-after 
  ""
  [ self ]
    (py/call-attr recurrent "reset_after"  self))
