...
(defn get-constants 
  ...
  [self  & {:keys [inputs training]} ]
    (py/call-attr-kw recurrent "get_constants" [self] {:inputs inputs :training training }))
...
(defn preprocess-input 
  ""
  [self  & {:keys [inputs training]} ]
    (py/call-attr-kw recurrent "preprocess_input" [self] {:inputs inputs :training training }))
...
(defn step 
  ...
  [self  & {:keys [inputs states]} ]
    (py/call-attr-kw recurrent "step" [self] {:inputs inputs :states states }))
