...
(defn RNN 
  ...
  [cell & {:keys [return_sequences return_state go_backwards stateful unroll]
    ...
    (py/call-attr-kw recurrent "RNN" [cell] {:return_sequences return_sequences :return_state return_state :go_backwards go_backwards :stateful stateful :unroll unroll }))
(defn add-loss 
