...
(defn Deconvolution3D 
  ...
  [filters kernel_size & {:keys [strides padding output_padding data_format activation use_bias kernel_initializer bias_initializer kernel_regularizer bias_regularizer activity_regularizer kernel_constraint bias_constraint]
    ...
    (py/call-attr-kw layers "Deconvolution3D" [filters kernel_size] {:strides strides :padding padding :output_padding output_padding :data_format data_format :activation activation :use_bias use_bias :kernel_initializer kernel_initializer :bias_initializer bias_initializer :kernel_regularizer kernel_regularizer :bias_regularizer bias_regularizer :activity_regularizer activity_regularizer :kernel_constraint kernel_constraint :bias_constraint bias_constraint }))
(defn add-loss 
