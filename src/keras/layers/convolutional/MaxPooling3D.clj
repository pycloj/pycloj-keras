(ns keras.layers.convolutional.MaxPooling3D
...
(defn MaxPooling3D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw convolutional "MaxPooling3D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
(defn add-loss 
