(ns keras.layers.convolutional.AveragePooling2D
...
(defn AveragePooling2D 
  ...
  [ & {:keys [pool_size strides padding data_format]
       :or {pool_size (2, 2) padding "valid"}} ]
  
   (py/call-attr-kw convolutional "AveragePooling2D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
(defn add-loss 
