(ns keras.layers.convolutional.AveragePooling3D
...
(defn AveragePooling3D 
  ...
  [ & {:keys [pool_size strides padding data_format]
       :or {pool_size (2, 2, 2) padding "valid"}} ]
  
   (py/call-attr-kw convolutional "AveragePooling3D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
