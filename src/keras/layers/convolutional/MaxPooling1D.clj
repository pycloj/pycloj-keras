(ns keras.layers.convolutional.MaxPooling1D
...
(defn MaxPooling1D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw convolutional "MaxPooling1D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
(defn add-loss 
