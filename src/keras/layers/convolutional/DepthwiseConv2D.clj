(ns keras.layers.convolutional.DepthwiseConv2D
...
(defn DepthwiseConv2D 
  "Depthwise 2D convolution.
    ...
    # Output shape
        ...
        `rows` and `cols` values might have changed due to padding.
    "
  [kernel_size & {:keys [strides padding depth_multiplier data_format dilation_rate activation use_bias depthwise_initializer bias_initializer depthwise_regularizer bias_regularizer activity_regularizer depthwise_constraint bias_constraint]
                       :or {strides (1, 1) padding "valid" depth_multiplier 1 dilation_rate (1, 1) use_bias true depthwise_initializer "glorot_uniform" bias_initializer "zeros"}} ]
    (py/call-attr-kw convolutional "DepthwiseConv2D" [kernel_size] {:strides strides :padding padding :depth_multiplier depth_multiplier :data_format data_format :dilation_rate dilation_rate :activation activation :use_bias use_bias :depthwise_initializer depthwise_initializer :bias_initializer bias_initializer :depthwise_regularizer depthwise_regularizer :bias_regularizer bias_regularizer :activity_regularizer activity_regularizer :depthwise_constraint depthwise_constraint :bias_constraint bias_constraint }))
(defn add-loss 
