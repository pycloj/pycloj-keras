(ns keras.layers.convolutional.UpSampling2D
...
(defn UpSampling2D 
  ...
  [ & {:keys [size data_format interpolation]
       :or {size (2, 2) interpolation "nearest"}} ]
  
   (py/call-attr-kw convolutional "UpSampling2D" [] {:size size :data_format data_format :interpolation interpolation }))
(defn add-loss 
