(ns keras.layers.convolutional.AveragePooling1D
...
(defn AveragePooling1D 
  ...
  [ & {:keys [pool_size strides padding data_format]
       :or {pool_size 2 padding "valid" data_format "channels_last"}} ]
  
   (py/call-attr-kw convolutional "AveragePooling1D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
