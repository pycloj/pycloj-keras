  ...
  "Fast GRU implementation backed by [CuDNN](https://developer.nvidia.com/cudnn).
    ...
    # Arguments
        ...
        stateful: Boolean (default False). If True, the last state
            ...
            state for the sample of index i in the following batch.
    "
  [units & {:keys [kernel_initializer recurrent_initializer bias_initializer kernel_regularizer recurrent_regularizer bias_regularizer activity_regularizer kernel_constraint recurrent_constraint bias_constraint return_sequences return_state stateful]
