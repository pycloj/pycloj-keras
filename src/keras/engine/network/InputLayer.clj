(ns keras.engine.network.InputLayer
...
(defn InputLayer 
  ...
  [ & {:keys [input_shape batch_size batch_input_shape dtype input_tensor sparse name]
   ...
   (py/call-attr-kw network "InputLayer" [] {:input_shape input_shape :batch_size batch_size :batch_input_shape batch_input_shape :dtype dtype :input_tensor input_tensor :sparse sparse :name name }))
...
(defn call 
  "This is where the layer's logic lives.
        ...
        "
  [self  & {:keys [inputs]} ]
    (py/call-attr-kw network "call" [self] {:inputs inputs }))
