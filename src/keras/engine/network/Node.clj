...
(defn Node 
  ...
  [outbound_layer inbound_layers node_indices tensor_indices input_tensors output_tensors input_masks output_masks input_shapes output_shapes  & {:keys [arguments]} ]
    (py/call-attr-kw network "Node" [outbound_layer inbound_layers node_indices tensor_indices input_tensors output_tensors input_masks output_masks input_shapes output_shapes] {:arguments arguments }))
