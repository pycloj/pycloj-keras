(ns keras.backend.tensorflow-backend
  ""
...
(defn get-uid 
  ...
  [ & {:keys [prefix]
   ...
   (py/call-attr-kw tensorflow-backend "get_uid" [] {:prefix prefix }))
...
(defn placeholder 
  ...
  [ & {:keys [shape ndim dtype sparse name]
   ...
   (py/call-attr-kw tensorflow-backend "placeholder" [] {:shape shape :ndim ndim :dtype dtype :sparse sparse :name name }))
