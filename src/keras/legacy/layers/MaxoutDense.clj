(ns keras.legacy.layers.MaxoutDense
...
(defn MaxoutDense 
  "A dense maxout layer.
    ...
    # References
        - [Maxout Networks](http://arxiv.org/abs/1302.4389)
    "
  [output_dim & {:keys [nb_feature init weights W_regularizer b_regularizer activity_regularizer W_constraint b_constraint bias input_dim]
                       :or {nb_feature 4 init "glorot_uniform" bias true}} ]
    (py/call-attr-kw layers "MaxoutDense" [output_dim] {:nb_feature nb_feature :init init :weights weights :W_regularizer W_regularizer :b_regularizer b_regularizer :activity_regularizer activity_regularizer :W_constraint W_constraint :b_constraint b_constraint :bias bias :input_dim input_dim }))
(defn add-loss 
