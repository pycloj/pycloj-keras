(ns keras.legacy.layers.Recurrent
...
(defn Recurrent 
  ...
  [ & {:keys [return_sequences return_state go_backwards stateful unroll implementation]
   ...
   (py/call-attr-kw layers "Recurrent" [] {:return_sequences return_sequences :return_state return_state :go_backwards go_backwards :stateful stateful :unroll unroll :implementation implementation }))
(defn add-loss 
